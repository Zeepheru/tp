...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TAHub Contacts")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a contact with a name, email, and optionally a phone number, address, and tags.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the input fields:")]),_v(" "),_c('ul',[_c('li',[_v("a. Checks if the name is valid (alphabets and spaces only).")]),_v(" "),_c('li',[_v("b. Checks if the email format is valid and unique.")]),_v(" "),_c('li',[_v("c. (Optional) Checks if the phone number is valid (8 digits) and unique.")]),_v(" "),_c('li',[_v("d. (Optional) Validates address and tags.")])])]),_v(" "),_c('li',[_c('p',[_v("System adds the contact if all validations pass.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message, \"New contact added: [Contact details].\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The name is in an invalid format.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Invalid name format.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. The email is invalid or already exists.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System shows an error message, \"Invalid email format.\" or \"Contact already exists.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2c. The phone number is invalid or already exists.")]),_v(" "),_c('ul',[_c('li',[_v("2c1. System shows an error message, \"Invalid phone number format.\" or \"Phone number already exists.\"\nUse case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves and displays the list of all contacts with their details (name, phone number, email, address, tags).")])]),_v(" "),_c('li',[_c('p',[_v("User views the list to get an overview of student contact information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Get Warnings Before Making Major Changes")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor initiates a major change (e.g., deleting a student record or modifying multiple student details at once).")])]),_v(" "),_c('li',[_c('p',[_v("System detects the action as a major change.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor with a warning message describing the potential consequences (e.g., \"Warning: You are about to delete [Student's name]. This action cannot be undone. Do you wish to proceed?\").")])]),_v(" "),_c('li',[_c('p',[_v("Tutor reviews the warning and confirms whether to proceed or cancel.")])]),_v(" "),_c('li',[_c('p',[_v("If confirmed, the system proceeds with the requested changes and displays a success message.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The list is empty.\n"),_c('ul',[_c('li',[_v("2a1. System shows a message, \"No contacts available.\"\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a contact by providing the index of the contact in the list.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided index.")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the contact if the index is valid.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message, \"Deleted contact: [Contact details].\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The index is out of bounds.\n"),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Invalid index.\"\nUse case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit the contact by providing the index of the contact and the fields to update (name, phone, email, address, tags).")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided index and input fields:")]),_v(" "),_c('ul',[_c('li',[_v("a. Checks if the contact at the given index exists.")]),_v(" "),_c('li',[_v("b. Validates the new name, email, phone, address, and tags as per the same rules as in the add contact case.")])])]),_v(" "),_c('li',[_c('p',[_v("System updates the contact with the new details if all validations pass.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message, \"Contact updated: [Updated contact details].\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The index is out of bounds.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Invalid index.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. The new name is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System shows an error message, \"Invalid name format.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2c. The new email is invalid or already exists.")]),_v(" "),_c('ul',[_c('li',[_v("2c1. System shows an error message, \"Invalid email format.\" or \"Contact already exists.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2d. The new phone number is invalid or already exists.")]),_v(" "),_c('ul',[_c('li',[_v("2d1. System shows an error message, \"Invalid phone number format.\" or \"Phone number already exists.\"\nUse case resumes at step 1.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add essential data about students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add essential data (such as progress or status) for a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user to provide the student’s essential data, such as progress, performance, or notes.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the input and associates the data with the correct student.")])]),_v(" "),_c('li',[_c('p',[_v("System confirms the addition of the data with a success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided data is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Invalid data format.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. The student does not exist in the system.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows an error message, \"Student not found.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View essential data about students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view essential data for a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves and displays the student's essential data, such as progress, performance, or notes.")])]),_v(" "),_c('li',[_c('p',[_v("User views the essential data to track the student's progress.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The student does not exist in the system.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Student not found.\"\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. No essential data has been recorded for the student.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System shows a message, \"No essential data available for this student.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete essential data about students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete essential data for a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user for confirmation to delete the essential data for the student.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the deletion.")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the student’s essential data and shows a success message, \"Essential data for [Student] has been deleted.\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The student does not exist in the system.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Student not found.\"\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. User cancels the deletion.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System aborts the deletion process.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. No essential data exists for the student.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System shows a message, \"No essential data to delete for this student.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit essential data about students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit essential data for a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user to provide new or updated essential data for the student.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the input and updates the student’s essential data.")])]),_v(" "),_c('li',[_c('p',[_v("System shows a success message, \"Essential data for [Student] has been updated.\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The student does not exist in the system.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Student not found.\"\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. The provided data is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System shows an error message, \"Invalid data format.\"\nUse case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. No changes were made to the data.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System shows a message, \"No changes detected.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Search students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find students by providing keywords.")])]),_v(" "),_c('li',[_c('p',[_v("System searches for contacts whose names contain the given keywords (case-insensitive).")])]),_v(" "),_c('li',[_c('p',[_v("System displays the matching contacts if found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. No contacts match the keywords.\n"),_c('ul',[_c('li',[_v("2a1. System shows a message, \"No contacts found.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Sort students by grades")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to sort students by their grades.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves all students and their corresponding grades.")])]),_v(" "),_c('li',[_c('p',[_v("System sorts the students by grades in ascending order (prioritizing weaker students).")])]),_v(" "),_c('li',[_c('p',[_v("System displays the sorted list of students with their grades for follow-up.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("3a. No students have grades recorded.\n"),_c('ul',[_c('li',[_v("3a1. System shows a message, \"No grade data available for sorting.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete students in bulk")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete multiple students from the system.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user to confirm the deletion of the selected students.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the bulk deletion.")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the selected students and displays a success message for the deletion.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User does not select any students for deletion.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows a message, \"No students selected for deletion.\"\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("2a. User cancels the deletion.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System aborts the bulk deletion process.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. One or more of the selected students do not exist in the system.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System skips deleting non-existent students and completes deletion for valid students.")]),_v(" "),_c('li',[_v("4a2. System shows a message, \"Some students could not be deleted as they do not exist.\"")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add filters to searches")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to search for students with additional filters (e.g., by grade, tag, or other criteria).")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user to specify the filters (e.g., grade range, specific tag, etc.).")])]),_v(" "),_c('li',[_c('p',[_v("User specifies the filters and submits the search request.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves students that match the specified filters and displays the filtered list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided filter is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message, \"Invalid filter. Please provide valid criteria.\"\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. No students match the specified filters.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System shows a message, \"No students found matching the filters.\"\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. Tutor cancels the operation.")]),_v(" "),_c('ul',[_c('li',[_v("System aborts the change and returns to the previous state.")]),_v(" "),_c('li',[_v("System displays a message: \"Operation cancelled.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Explore App with Sample Student Data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects an option to load the app with sample student data.")])]),_v(" "),_c('li',[_c('p',[_v("System loads pre-populated sample student data into the app.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor interacts with the sample data, testing features such as adding, editing, and deleting students, without affecting any real data.")])]),_v(" "),_c('li',[_c('p',[_v("System processes tutor actions using the sample data.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor completes the exploration of the app and returns to normal mode.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a message confirming that all changes made in the sample mode are not saved.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Access Help for Available Commands")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor requests help (e.g., by typing a help command or selecting a help option from the menu).")])]),_v(" "),_c('li',[_c('p',[_v("System displays a list of available commands and their descriptions.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor reviews the commands and selects one for further clarification.")])]),_v(" "),_c('li',[_c('p',[_v("System provides detailed usage instructions and examples for the selected command.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor follows the instructions to learn how to use the specific functionality.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("3a. Tutor requests help for an unsupported command.")]),_v(" "),_c('ul',[_c('li',[_v("System shows an error message: \"Command not recognized. Please review the available commands.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Bulk Import Student Data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the bulk import option in the system.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor to upload a file containing student data in the required format (e.g., CSV).")])]),_v(" "),_c('li',[_c('p',[_v("Tutor uploads the file.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the file format and student data based on predefined rules (e.g., required fields such as name, email, and valid formats).")])]),_v(" "),_c('li',[_c('p',[_v("If validation passes, system imports the students into the app.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Successfully imported [number] students.\"")])]),_v(" "),_c('li',[_c('p',[_v("Tutor reviews the imported student data.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("4a. File format is invalid.")])]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Invalid file format. Please use the correct format (e.g., CSV).\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("4b. Some student data is invalid.")])]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Error importing [X] students due to invalid data (e.g., missing fields, invalid email format). Please correct the data and try again.\"")]),_v(" "),_c('li',[_v("System provides the option to retry the import after corrections.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Export Contact List to a CSV")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the option to export the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor to specify the file name and location for the CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor confirms the file name and location.")])]),_v(" "),_c('li',[_c('p',[_v("System generates the CSV file with the contact list, including details such as name, phone number, email, and address.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Contact list successfully exported to [file location].\"")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("2a. Export fails due to file system error (e.g., permission denied).")]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Export failed. Please check your file permissions and try again.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Merge Duplicate Student Entries")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the option to merge duplicate student entries.")])]),_v(" "),_c('li',[_c('p',[_v("System scans the contact list for potential duplicates (based on name, email, or phone number).")])]),_v(" "),_c('li',[_c('p',[_v("System presents the tutor with a list of duplicate entries and prompts for confirmation of the merge.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor confirms which entries to merge.")])]),_v(" "),_c('li',[_c('p',[_v("System merges the selected entries and updates the contact list accordingly.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Duplicates successfully merged.\"")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("3a. No duplicates found.")])]),_v(" "),_c('ul',[_c('li',[_v("System displays a message: \"No duplicates found in the contact list.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("4a. Tutor cancels the merge.")])]),_v(" "),_c('ul',[_c('li',[_v("System aborts the merge operation and returns to the previous screen.")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Filter Students by Attendance Status")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the option to filter students by attendance status.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor to choose a specific attendance status (e.g., present, absent, late).")])]),_v(" "),_c('li',[_c('p',[_v("Tutor selects the desired attendance status.")])]),_v(" "),_c('li',[_c('p',[_v("System filters and displays the list of students matching the selected attendance status.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor reviews the filtered list to track or follow up with the absent students.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. No students match the selected attendance status.")]),_v(" "),_c('ul',[_c('li',[_v("System displays a message: \"No students match the selected attendance status.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Sort Students Alphabetically")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the option to sort students alphabetically.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor to choose a sorting criterion (e.g., by first name, by last name).")])]),_v(" "),_c('li',[_c('p',[_v("Tutor selects the desired criterion.")])]),_v(" "),_c('li',[_c('p',[_v("System sorts the students based on the selected criterion.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor reviews the sorted contact list for quick reference or location.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. Contact list is empty.")]),_v(" "),_c('ul',[_c('li',[_v("System displays a message: \"No students available to sort.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Add Comments to Student Profiles")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects a student profile.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor chooses the option to add a comment to the student's profile.")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the tutor to enter the comment.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor enters the desired observation or important information about the student as a comment.")])]),_v(" "),_c('li',[_c('p',[_v("System saves the comment and associates it with the student's profile.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Comment added to [Student's name] profile.\"")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. Comment is empty or invalid.")]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Invalid comment. Please enter a valid comment.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Assign Preferred Communication Methods to Parents")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects a student profile.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor chooses the option to assign a preferred communication method for the student's parents.")])]),_v(" "),_c('li',[_c('p',[_v("System displays available communication methods (e.g., phone, email, messaging apps).")])]),_v(" "),_c('li',[_c('p',[_v("Tutor selects one or more preferred methods.")])]),_v(" "),_c('li',[_c('p',[_v("System saves the selected preferences for the student's parents.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Preferred communication method(s) saved for [Student's name] parents.\"")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. No communication method selected.")]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Please select at least one communication method.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Flag Students with Missing Contact Details")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects the option to check for missing contact details.")])]),_v(" "),_c('li',[_c('p',[_v("System scans the contact list for students with incomplete or missing contact information (e.g., missing phone number or email).")])]),_v(" "),_c('li',[_c('p',[_v("System displays a list of students with incomplete contact details.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor chooses to review the flagged students and updates the missing information as needed.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("3a. No students with missing contact details.")]),_v(" "),_c('ul',[_c('li',[_v("System displays a message: \"All student contact details are complete.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Set Communication Preferences for Individual Students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor selects a student profile.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor chooses the option to set a preferred communication method for the student.")])]),_v(" "),_c('li',[_c('p',[_v("System displays available communication methods (e.g., Telegram, phone, email).")])]),_v(" "),_c('li',[_c('p',[_v("Tutor selects the student's preferred method.")])]),_v(" "),_c('li',[_c('p',[_v("System saves the selected preference.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message: \"Preferred communication method saved for [Student's name].\"")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("4a. No communication method selected.")]),_v(" "),_c('ul',[_c('li',[_v("System displays an error message: \"Please select a communication method.\"")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 1 Oct 2024, 22:13:30 GMT+8]")])])])}
}];
